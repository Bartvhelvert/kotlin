...
import org.jetbrains.kotlin.resolve.jvm.TopPackageAwareSearchScope
...
internal open class PoweredLibraryScopeBase(project: Project, classes: Array<VirtualFile>, sources: Array<VirtualFile>) :
    LibraryScopeBase(project, classes, sources), TopPackageAwareSearchScope {
    ...
    override val topPackageNames: Set<String> = run {
        (classes + sources)
